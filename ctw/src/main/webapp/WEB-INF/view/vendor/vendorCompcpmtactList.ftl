...
<div id="tbPerson" style="padding: 5px">
    <form class="form-inline" role="form">
...
<div id="dlgPerson" class="easyui-dialog" data-options="closed:true,border:false,modal:true" style="width:720px;height:500px;">
    <form role="form"  action="/vendor/save" id="formPerson">
...
<div id="menu2" class="easyui-menu" style="width: 50px; display: none;">
    <!--放置一个隐藏的菜单Div-->
