...
(function () {
    ...
    jutil.prototype = {
        ...
        tiptype: function (msg, o, cssctl) {
            var $p = o.obj.parent(), $span = $p.find('.Validform_checktip').length == 1 ? $p.find('.Validform_checktip') : $p.parent().find('.Validform_checktip');
         ...
         * */
        modelShow: function () {
            var $body = $('body').height() == 0 ? $(document) : $('body'), to = (($body.scrollTop() + $body.height()) >> 1) - 50, lef = ($body.scrollLeft() + $body.width()) >> 1;
            var html = ['<div class="datagrid-mask js-model" style="position:absolute;display:block;z-index:' + this.getSequence() + ';width:3000px;height: 3000px;"></div>'];
        ...
        getDictListByType: function (type) {
            var list = [];
            $.ajax({
                url: context + '/dictionarry/findList',
                data: {typeVal: type, sortColumns: 'id', order: 'asc'},
                dataType: 'json',
                async: false,
        ...
        getDictMapByData: function (datas) {
            ...
            for (var i in datas) {
                var data = datas[i];
                // map[data.currencycode]=data.description;
        ...
        /**
         * 消息通知(daterangepicker)
         * Success          Info         Warning         Error
         */
        showTips: function (type, tips) {
            toastr.options = {
                "closeButton": false,
                "debug": false,
                "newestOnTop": false,
        ...
        /**easyUI Msg
         *  type :TL TC TR CL C CR BL BC BR
         * */

        topLeft: function (message, title) {
            $.messager.show({
                title: title,
                msg: message,
                showType: 'show',
        ...
        topCenter: function (message, title) {
            $.messager.show({
                title: title,
                msg: message,
                showType: 'slide',
        ...
        topRight: function (message, title) {
            $.messager.show({
                title: title,
                msg: message,
                showType: 'show',
        ...
        centerLeft: function (message, title) {
            $.messager.show({
                title: title,
                msg: message,
                showType: 'fade',
        ...
        centerRight: function (message, title) {
            $.messager.show({
                title: title,
                msg: message,
                showType: 'fade',
        ...
        bottomLeft: function (message, title) {
            $.messager.show({
                title: title,
                msg: message,
                showType: 'show',
        ...
        bottomCenter: function (message, title) {
            $.messager.show({
                title: title,
                msg: message,
                showType: 'slide',
        ...
        bottomRight: function (message, title) {
            $.messager.show({
                title: title,
                msg: message,
                showType: 'show'
